...
;; ## added by OPAM user-setup for emacs / tuareg ## 1e50c0fc4a3d57fccc66be128156a006 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/beshr/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
